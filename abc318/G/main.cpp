...
const string NO = "No";
// clang-format on
void solve(long long N, long long M, long long A, long long B, long long C, std::vector<long long> U, std::vector<long long> V) {
...
int main() {
    ...
    solve(N, M, A, B, C, std::move(U), std::move(V));
    return 0;
}
