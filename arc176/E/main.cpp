...
const ll INF = 1e18;
// clang-format on
void solve(long long N, long long M, std::vector<long long> X, std::vector<long long> Y, std::vector<std::vector<long long>> A) {
...
int main() {
    ...
    solve(N, M, std::move(X), std::move(Y), std::move(A));
    return 0;
}
