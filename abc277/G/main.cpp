...
// clang-format on
void solve(long long N, long long M, long long K, std::vector<long long> u, std::vector<long long> v, std::vector<long long> C) {
...
int main() {
    ...
    solve(N, M, K, std::move(u), std::move(v), std::move(C));
    return 0;
}
