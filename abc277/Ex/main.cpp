...
// clang-format on
void solve(long long N, long long M, long long Q, std::vector<long long> A, std::vector<long long> B, std::vector<long long> L, std::vector<long long> R) {
...
int main() {
    ...
    solve(N, M, Q, std::move(A), std::move(B), std::move(L), std::move(R));
    return 0;
}
