...
void solve(long long N, long long X, long long Y, long long Z, std::vector<long long> A, std::vector<long long> B) {
...
int main() {
    ...
    solve(N, X, Y, Z, std::move(A), std::move(B));
    return 0;
}
