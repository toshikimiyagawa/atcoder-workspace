...
// clang-format on
void solve(long long N, long long M, std::vector<long long> A, std::vector<long long> L, std::vector<long long> R, std::vector<long long> X) {
...
int main() {
    ...
    solve(N, M, std::move(A), std::move(L), std::move(R), std::move(X));
    return 0;
}
