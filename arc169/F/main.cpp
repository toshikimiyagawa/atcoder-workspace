...
// clang-format on
void solve(long long N, std::vector<long long> A, std::vector<long long> B, std::vector<long long> X, std::vector<long long> Y) {
...
int main() {
    ...
    solve(N, std::move(A), std::move(B), std::move(X), std::move(Y));
    return 0;
}
