...
// clang-format on
void solve(long long N, long long M, long long K, std::vector<long long> P, std::vector<long long> S, std::vector<long long> T) {
...
int main() {
    ...
    solve(N, M, K, std::move(P), std::move(S), std::move(T));
    return 0;
}
