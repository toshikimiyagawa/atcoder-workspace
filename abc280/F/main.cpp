...
// clang-format on
void solve(long long N, long long M, long long Q, std::vector<long long> A, std::vector<long long> B, std::vector<long long> C, std::vector<long long> X, std::vector<long long> Y) {
...
int main() {
    ...
    solve(N, M, Q, std::move(A), std::move(B), std::move(C), std::move(X), std::move(Y));
    return 0;
}
