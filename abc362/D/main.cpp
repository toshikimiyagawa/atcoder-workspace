...
const ll INF = 1e18;
// clang-format on
void solve(long long N, long long M, std::vector<long long> A, std::vector<long long> U, std::vector<long long> V, std::vector<long long> B) {
...
int main() {
    ...
    solve(N, M, std::move(A), std::move(U), std::move(V), std::move(B));
    return 0;
}
