...
const ll INF = 1e18;
// clang-format on
void solve(long long N, long long M, std::vector<long long> u, std::vector<long long> v, std::vector<long long> b, std::vector<long long> c) {
...
int main() {
    ...
    solve(N, M, std::move(u), std::move(v), std::move(b), std::move(c));
    return 0;
}
