...
//            cout << i << endl;
//            cout << q1 << endl;
//            cout << s[lower_bound(s.begin(), s.end(), q1) - s.begin()] << endl;
            if (q1 == s[lower_bound(s.begin(), s.end(), q1) - s.begin()]) {
                ll r1 = s[lower_bound(s.begin(), s.end(), q1) - s.begin()] + R;
                if (r1 == s[lower_bound(s.begin(), s.end(), r1) - s.begin()]) {
                    cout << YES << endl;
                    return;
                }
            }
...
int main() {
    ...
    long long P;
    (void) std::scanf("%lld", &P);
    long long Q;
    (void) std::scanf("%lld", &Q);
    long long R;
    (void) std::scanf("%lld", &R);
