...
const ll INF = 1e18;
// clang-format on
void solve(long long N, long long X, long long Y, std::vector<long long> P, std::vector<long long> T, long long Q, std::vector<long long> q) {
...
int main() {
    ...
    solve(N, X, Y, std::move(P), std::move(T), Q, std::move(q));
    return 0;
}
