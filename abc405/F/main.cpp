...
const ll INF = 1e18;
// clang-format on
void solve(long long N, long long M, std::vector<long long> A, std::vector<long long> B, long long Q, std::vector<long long> C, std::vector<long long> D) {
...
int main() {
    ...
    solve(N, M, std::move(A), std::move(B), Q, std::move(C), std::move(D));
    return 0;
}
